...
int Plot::CheckObs(const QString &file)
{
    ...
    if (file.indexOf('.')==-1) return 0;
    int p=file.lastIndexOf('.');
    if (file.indexOf(".z")!=-1||file.indexOf(".gz")!=-1||file.indexOf(".zip")!=-1||
        file.indexOf(".Z")!=-1||file.indexOf(".GZ")!=-1||file.indexOf(".ZIP")!=-1) {
        return file.at(p-1)=='o'||file.at(p-1)=='O'||file.at(p-1)=='d'||file.at(p-1)=='D';
    }
    return file.indexOf(".obs")!=-1||file.indexOf(".OBS")!=-1||
